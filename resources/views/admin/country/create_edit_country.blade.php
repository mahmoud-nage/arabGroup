          ...
          <div class="card-body">
            ...
            @if($record->name == null)
                   ...
                   @section('title')
                      {{__('اضافه بلد')}}
                    @endsection
                    <form class="form-horizontal" id="quickForm" method="POST" action="{{route('country.store')}}">
                ...
                @else
                   ...
                   @section('title')
                      {{__('تعديل بلد')}}
                   @endsection
                    <form class="form-horizontal" id="quickForm" method="POST" action="{{route('country.update', $record->id)}}">
                @endif
            @csrf 
              <div class="row">
